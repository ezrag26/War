...
int main()
{
	...
	TEST(TestSLCreateAndDestroy());
	TEST(TestSLInsert());
	TEST(TestSLRemoveReturn());
	TEST(TestSLRemoveSize());
	TEST(TestSLPopFront());
	TEST(TestSLPopBack());
	/*TEST(TestSLBegin());*/
	TEST(TestSLFind());
	TEST(TestSLFindValid());
	TEST(TestSLMergeSize());
	TEST(TestSLMergeValuesSL2Greater());
	TEST(TestSLMergeValuesSL1Greater());
	TEST(TestSLFindIf());
	TEST(TestSLForEach());
...
int TestSLMergeValuesSL2Greater()
{
	...
	printf("Testing MergeValuesSL2Greater...\n");
...
int TestSLMergeValuesSL1Greater()
{
	...
	printf("Testing MergeValuesSL1Greater...\n");
